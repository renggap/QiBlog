...
$result = get_posts_by_category($category, $page, 9); // Show 9 posts per page (3x3 grid)
$posts = $result['posts'];
...
<body>
    ...
    <div class="container">
        <header>
            ...
            <h1><?php echo htmlspecialchars(ucfirst($category), ENT_QUOTES, 'UTF-8'); ?></h1>
            <p class="subtitle"><?php echo $total_posts; ?> post<?php echo $total_posts !== 1 ? 's' : ''; ?> in this category</p>
        </header>
        ...
        <?php if (empty($posts)): ?>
            ...
            <div class="empty-state">
                ...
                <h2>No posts in <?php echo htmlspecialchars($category, ENT_QUOTES, 'UTF-8'); ?> category</h2>
        ...
        <?php else: ?>
            ...
            <div class="blog-grid">
                ...
                foreach ($posts as $index => $post):
                    ...
                    $postCategory = !empty($post['categories']) ? htmlspecialchars($post['categories'][0], ENT_QUOTES, 'UTF-8') : 'General';
                ?>
                    <div class="blog-card">
            ...
            <?php if ($result['total_pages'] > 1): ?>
                <div class="pagination">
                    <?php if ($page > 1): ?>
                        <a href="/<?php echo urlencode($category); ?>/?page=<?php echo $page - 1; ?>" class="page-btn">← Previous</a>
                    <?php endif; ?>
                    ...
                    if ($start_page > 1): ?>
                        <a href="/<?php echo urlencode($category); ?>/" class="page-btn">1</a>
                        <?php if ($start_page > 2): ?>
                    ...
                    <?php for ($i = $start_page; $i <= $end_page; $i++): ?>
                        <a href="/<?php echo urlencode($category); ?>/?page=<?php echo $i; ?>" class="page-btn <?php echo $i == $page ? 'active' : ''; ?>">
                            <?php echo $i; ?>
                        </a>
                    <?php endfor; ?>
                    ...
                    <?php if ($end_page < $result['total_pages']): ?>
                        <?php if ($end_page < $result['total_pages'] - 1): ?>
                            <span style="color: rgba(255, 255, 255, 0.7);">...</span>
                        <?php endif; ?>
                        <a href="/<?php echo urlencode($category); ?>/?page=<?php echo $result['total_pages']; ?>" class="page-btn">
                            <?php echo $result['total_pages']; ?>
                        </a>
                    <?php endif; ?>

                    <?php if ($page < $result['total_pages']): ?>
                        <a href="/<?php echo urlencode($category); ?>/?page=<?php echo $page + 1; ?>" class="page-btn">Next →</a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
        <?php endif; ?>
