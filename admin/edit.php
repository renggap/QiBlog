            ...
            <div class="form-container">
                <form method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" id="content" name="content" value="<?php echo htmlspecialchars($post['content']); ?>" required>
                        <trix-editor id="trix-content" input="content" placeholder="Write your post content here..."><?php echo $post['content']; ?></trix-editor>
                    </div>
